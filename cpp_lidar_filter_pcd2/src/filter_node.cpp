...
class LidarFilterNodePCD2 : public rclcpp::Node
{
public:
  LidarFilterNodePCD2() : Node("lidar_filter_node_pcd2")
  {
    ...
    this->declare_parameter("min_z", -0.6);
    ...
    sub_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
      ...
      std::bind(&LidarFilterNodePCD2::cloud_callback, this, std::placeholders::_1));
    ...
    timer_ = this->create_wall_timer(
     std::chrono::milliseconds(1000), std::bind(&LidarFilterNodePCD2::publish_marker, this));
  }
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<LidarFilterNodePCD2>());
  rclcpp::shutdown();
  return 0;
}