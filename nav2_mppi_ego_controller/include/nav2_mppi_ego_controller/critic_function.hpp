...
#ifndef NAV2_MPPI_EGO_CONTROLLER__CRITIC_FUNCTION_HPP_
#define NAV2_MPPI_EGO_CONTROLLER__CRITIC_FUNCTION_HPP_
...
#include "nav2_mppi_ego_controller/critic_data.hpp"

namespace mppi_ego::critics
{

/**
 * @class mppi_ego::critics::CollisionCost
...
/**
 * @class mppi_ego::critics::CriticFunction
...
public:
  /**
    * @brief Constructor for mppi_ego::critics::CriticFunction
    */
  CriticFunction() = default;

  /**
    * @brief Destructor for mppi_ego::critics::CriticFunction
    */
...
#endif  // NAV2_MPPI_EGO_CONTROLLER__CRITIC_FUNCTION_HPP_
