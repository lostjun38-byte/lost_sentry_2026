...
#ifndef NAV2_MPPI_EGO_CONTROLLER__OPTIMIZER_HPP_
#define NAV2_MPPI_EGO_CONTROLLER__OPTIMIZER_HPP_
...
#include "nav2_mppi_ego_controller/models/optimizer_settings.hpp"
#include "nav2_mppi_ego_controller/motion_models.hpp"
#include "nav2_mppi_ego_controller/critic_manager.hpp"
#include "nav2_mppi_ego_controller/models/state.hpp"
#include "nav2_mppi_ego_controller/models/trajectories.hpp"
#include "nav2_mppi_ego_controller/models/path.hpp"
#include "nav2_mppi_ego_controller/tools/noise_generator.hpp"
#include "nav2_mppi_ego_controller/tools/parameters_handler.hpp"
#include "nav2_mppi_ego_controller/tools/utils.hpp"

#ifdef __APPLE__
  #include "nav2_mppi_ego_controller/tools/apple_utils.hpp"
#endif
...
public:
  /**
    * @brief Constructor for mppi_ego::Optimizer
    */
  Optimizer() = default;

  /**
   * @brief Destructor for mppi_ego::Optimizer
   */
  ~Optimizer() {shutdown();}
...
protected:
  ...
  std::array<mppi_ego::models::Control, 4> control_history_;
  models::Trajectories generated_trajectories_;
  models::Path path_;
  xt::xtensor<float, 1> costs_;
  bool ignore_odom_angular_velocity_{false};
...
#endif  // NAV2_MPPI_EGO_CONTROLLER__OPTIMIZER_HPP_
