...
#ifndef NAV2_MPPI_EGO_CONTROLLER__TOOLS__UTILS_HPP_
#define NAV2_MPPI_EGO_CONTROLLER__TOOLS__UTILS_HPP_
...
inline void savitskyGolayFilter(
  ...
  std::array<mppi_ego::models::Control, 4> & control_history,
...
#endif  // NAV2_MPPI_EGO_CONTROLLER__TOOLS__UTILS_HPP_
