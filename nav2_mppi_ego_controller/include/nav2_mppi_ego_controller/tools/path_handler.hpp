...
#ifndef NAV2_MPPI_EGO_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
#define NAV2_MPPI_EGO_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
...
public:
  /**
    * @brief Constructor for mppi_ego::PathHandler
    */
  PathHandler() = default;

  /**
    * @brief Destructor for mppi_ego::PathHandler
    */
  ~PathHandler() = default;
...
#endif  // NAV2_MPPI_EGO_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
