...
#ifndef NAV2_MPPI_EGO_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
#define NAV2_MPPI_EGO_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
...
public:
  /**
    * @brief Constructor for mppi_ego::NoiseGenerator
    */
   ...
   */
  void initialize(
    mppi_ego::models::OptimizerSettings & settings,
   ...
   * @param is_holonomic If base is holonomic
   */
  void reset(mppi_ego::models::OptimizerSettings & settings, bool is_holonomic);
...
protected:
  ...
  mppi_ego::models::OptimizerSettings settings_;
  bool is_holonomic_;
...
#endif  // NAV2_MPPI_EGO_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
