...
#ifndef NAV2_MPPI_EGO_CONTROLLER__MOTION_MODELS_HPP_
#define NAV2_MPPI_EGO_CONTROLLER__MOTION_MODELS_HPP_

#include <cstdint>
#include <string>

#include "nav2_mppi_ego_controller/models/control_sequence.hpp"
...
public:
  /**
    * @brief Constructor for mppi_ego::MotionModel
    */
  MotionModel() = default;

  /**
    * @brief Destructor for mppi_ego::MotionModel
    */
...
/**
 * @class mppi_ego::AckermannMotionModel
...
public:
  /**
    * @brief Constructor for mppi_ego::AckermannMotionModel
    */
...
/**
 * @class mppi_ego::DiffDriveMotionModel
...
public:
  /**
    * @brief Constructor for mppi_ego::DiffDriveMotionModel
    */
...
/**
 * @class mppi_ego::OmniMotionModel
...
public:
  /**
    * @brief Constructor for mppi_ego::OmniMotionModel
    */
...
#endif  // NAV2_MPPI_EGO_CONTROLLER__MOTION_MODELS_HPP_
