...
#ifndef NAV2_MPPI_EGO_CONTROLLER__CRITIC_MANAGER_HPP_
#define NAV2_MPPI_EGO_CONTROLLER__CRITIC_MANAGER_HPP_
...
public:
  /**
    * @brief Constructor for mppi_ego::CriticManager
    */
  CriticManager() = default;

  /**
    * @brief Virtual Destructor for mppi_ego::CriticManager
    */
...
#endif  // NAV2_MPPI_EGO_CONTROLLER__CRITIC_MANAGER_HPP_
