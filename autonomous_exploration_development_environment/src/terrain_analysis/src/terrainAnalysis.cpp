...
double minDyObsRelZ = -0.5;//计算角度时，表示地面，用来计算出最点的真实高度
...
double vehicleHeight = 1.5;//0.256
...
int main(int argc, char **argv) {
  ...
  auto subOdometry = nh->create_subscription<nav_msgs::msg::Odometry>("lidar_odometry", 5, odometryHandler);
